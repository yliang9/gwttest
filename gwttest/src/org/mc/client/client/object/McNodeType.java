...
public enum McNodeType {
	...
	LINKMART (XMLElements.LINKMART.toString()),
	GUICONTAINER (XMLElements.GUICONTAINER.toString()),
	GUIACCESSPOINT (XMLElements.GUIACCESSPOINT.toString()),
	...
	PARAMETER (XMLElements.PARAMETER.toString()),
	PARAMETEROPTION (XMLElements.PARAMETEROPTION.toString()),
	ACCESSPOINT(XMLElements.ACCESSPOINT.toString()),
	CONTAINERAP(XMLElements.CONTAINER.toString()),
	ATTRIBUTEWRAPPER(XMLElements.ATTRIBUTEWRAPPER.toString()),
	FILTERWRAPPER(XMLElements.FILTERWRAPPER.toString()),
	ANALYSIS(XMLElements.ANALYSIS.toString()),
	PARTITIONROW(XMLElements.PARTITIONROW.toString()),
	MCUSER(XMLElements.MCUSER.toString());
	;
